...
<%@page import="Encryption.EncrptDecrypt"%>
...
<html lang="en">
    ...
    <body>
        <%
            String encrypted = (String) session.getAttribute("nzRQV");
            String key = (String) session.getAttribute("id");
            String username = EncrptDecrypt.decrypt(encrypted, key);
        %>
...
<!--                        <li class="nav-link">
        ...
        <section class="home">
            ...
            <div class="mainbg">
<!--                <a href="AddScheme.jsp">
                    <input type="button" class="createbtn" value="Add">
                </a>-->
                <div style="overflow-x:auto; overflow-y:auto;"
                    ...
                    <table>
                        ...
                        <tbody>
                            <% List<Scheme> list = Resource.MyFunctions.getRegionDivision(username); %>
                            ...
                            <tr>
                                ...
                                <td data-label="Edit">
                                    <a href="EditScheme.jsp?id=<%= s.getSrno() %>">
                                        <i class='bx bx-edit-alt icon'></i>
                                    </a>
                                </td>
<!--                                <td data-label="Delete">
                                    <a href="Deleter?id=<%= s.getSrno() %>">
