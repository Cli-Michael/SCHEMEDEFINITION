...
//            out.println("<html>");
//            out.println("<head>");
//            out.println("<title>Servlet AddScheme</title>");            
//            out.println("</head>");
//            out.println("<body>");
//            out.println("<h1>Servlet AddScheme at " + request.getContextPath() + "</h1>");
//            out.println("</body>");
//            out.println("</html>");
//        }
//    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        int s = Resource.MyFunctions.universalInsert("Scheme", columnsArray, valuesArray);
