...
//       String InfoKey = "ssshhh__";
       String info = request.getParameter("info"); 
//       String infoDecrypted = EncrptDecrypt.decrypt(info, InfoKey);
       int status = Resource.MyFunctions.deleteAgent(info);
       if(status>0){
           out.print("<script>\n" +
"  setTimeout(function() {window.location.href='Users.jsp'}, 1);</script>");
        }else{
           out.print("<script>alert('Agent not deleted....');\n" +
"  setTimeout(function() {window.location.href='Users.jsp'}, 1);</script>");
       }
    }
